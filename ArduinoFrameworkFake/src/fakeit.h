...
#ifndef __GNUG__
            return file + std::string("(") + std::string((const char*)num) + std::string(")"); //std::to_string(num) + std::string(")");
#else
            return file + std::string(":") + std::string((const char*)num); //std::to_string(num);
#endif
        }
