...
def makeRegulatorPlot (import_file, name):
    ...
    fig, ((ax0, ax3), (ax1, ax4), (ax2, ax5)) = plt.subplots(3,2, facecolor=light_grey_c)
    ...
    ax5.plot(time5, speed_current1, 'r-o', label=label_ax5, lw=2, color=red_c)
...
makeRegulatorPlot("regulator_data_test_(1-7)_3", "Graficos Regulador. Test (1-7)_3")
